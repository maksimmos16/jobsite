...
<table class="order-details">
	<thead>
		<tr>
			<th class="product"><?php _e( 'Package', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
			<th class="quantity"><?php _e( 'Validity', 'woocommerce-pdf-invoices-packing-slips' ); ?></th>
	...
	<tbody>
		<?php foreach ( $this->get_order_items() as $item_id => $item ) : ?>
			<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', 'item-'.$item_id, $this->get_type(), $this->order, $item_id ); ?>">
				...
				<td class="quantity"><?php echo get_post_meta($item['product_id'], 'package_expiry_days', true ).' Days'; ?></td>
